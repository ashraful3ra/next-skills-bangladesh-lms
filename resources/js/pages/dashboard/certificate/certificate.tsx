...
import { Award, Check, Edit, Plus, Trash2 } from 'lucide-react';
import { useState } from 'react';
import CertificatePreview from './partials/certificate-preview';
         ...
         <div className="space-y-6">
            <div className="flex items-center justify-between">
               <div>
                  ...
                  <p className="text-muted-foreground mt-2">Manage your certificate templates for course completion</p>
               </div>
