...
export default function PaymentHistories({ paymentHistories, courses }: { paymentHistories: any, courses: any[] }) {
    ...
    const columns: ColumnDef<any>[] = [
        ...
        // ✅ Created By Column (Fixed: Shows ONLY the creator from DB)
        {
            accessorKey: 'created_by',
            header: 'Created By',
            cell: ({ row }) => {
                const creator = row.original.created_by;
                // যদি ডাটাবেসে নাম থাকে, তবেই সেটা দেখাবে।
                const displayName = creator ? creator.name : 'System/Self';
        ...
        },
        {
            ...
            cell: ({ row }) => {
                ...
                else if(status === 'Refunded') className = "bg-gray-800 text-white hover:bg-gray-900 border-gray-700";
        ...
        },
        {
            ...
            cell: ({ row }) => (
                <DeleteModal
                    ...
                    description="Are you sure you want to delete this payment record? It will be logged."
                    actionComponent={
